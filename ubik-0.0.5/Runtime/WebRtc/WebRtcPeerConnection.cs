...
namespace Ubik.WebRtc
{
    ...
    /// Signalling is through the UCL CVE (WebRtcPeerConnection implements INetworkComponent, and expects to register for a NetworkContext)
    /// </summary>
    [NetworkComponentId(typeof(WebRtcPeerConnection), 7)]
    public class WebRtcPeerConnection : MonoBehaviour, IManagedPeerConnectionObserver, INetworkComponent
    {
        ...
        void Start()
        {
            ...
            config.Servers = new PeerConnectionInterface.IceServer[] { new PeerConnectionInterface.IceServer() { Uri = "stun:stun.l.google.com:19302" } };
